...
public class CustomerApiClient(DaprClient daprClient, IHttpContextAccessor httpContextAccessor)
    : BaseDaprApiClient(daprClient, httpContextAccessor), ICustomerApiClient
{
